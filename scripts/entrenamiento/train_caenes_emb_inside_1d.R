...
network_inputs <- pre_process(df, text_variable =  "glosa_dep", label =  "seccion", type = "sequences")
...
model <- load_model_hdf5("data/finales/modelos/modelo_red_emb_simple_1d")
...
# Change name of variable to facilitate the programm
keys_1d <- keys_1d %>% 
