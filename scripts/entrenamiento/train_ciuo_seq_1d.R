...
# Save the model
save_model_hdf5(model, "data/finales/modelos/modelo_red_seq_1d_ciuo")
save_text_tokenizer(tokenizer, filename = "data/finales/modelos/tokenizer_stemm_1d_ciuo")

# Save keys to recover original labels
write_feather(keys, "data/finales/modelos/keys_1d_ciuo.feather")
