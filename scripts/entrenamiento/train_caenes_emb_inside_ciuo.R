...
#save_text_tokenizer(network_inputs$tokenizer, filename = "data/finales/modelos/tokenizer")
...
# model <- load_model_hdf5("data/finales/modelos/modelo_red_emb_simple")
# tokenizer <- load_text_tokenizer("data/finales/modelos/tokenizer")
# 
