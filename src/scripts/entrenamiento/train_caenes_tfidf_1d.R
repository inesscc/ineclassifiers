...
#write_feather(keys, "data/finales/llaves.feather")
...
# Save the model
save_model_hdf5(model, "data/finales/modelos/modelo_red_tfidf_1d")
save_text_tokenizer(tokenizer, filename = "data/finales/modelos/tokenizer_tfidf_1d")

# Save the orginal labels
#write_feather(network_inputs$keys, path = "data/finales/modelos/keys_1d.feather")
